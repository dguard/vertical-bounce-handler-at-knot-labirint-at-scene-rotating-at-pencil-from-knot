...
function KnotLabirintFromRotated() {
    let that = this
    ...
    let passThrough = window['@pencil/draft-knot-labirint-from-rotated']['passThrough']
...
window['@pencil/viewported-knot-at-pub'] = {
    KnotLabirintFromRotated,
    KnotLabirint,
    KnotFromCubicProjectFromBottomStatement,
